...
const departments = {
    "Engineering Faculty": [
        ...
        {
            name: "Department of Transport and Logistics Management",
            code: "TLM",
        },
    ...
    "Medical Faculty": [
        ...
        {
            name: "Department of Microbiology and Parasitology",
            code: "MICROPARA",
        },
        { name: "Department of Pharmacology", code: "PHARM" },
        { name: "Department of Physiology", code: "PHYS" },
        {
            name: "Department of Pathology and Forensic Medicine",
            code: "PATHFM",
        },
        {
